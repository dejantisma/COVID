    ...
    return (
      <View style={styles.container}>
            <View style={styles.card}>
                ...
                <Text style={{ fontSize: 30, textAlign: "center", color: '#000' }}>{route.params.total}</Text>
            </View>

            <View style={styles.card}>
                <Text style={{ padding: 16, fontSize: 38, textAlign: "center", color: "red" }}>Total deaths</Text>
                <Text style={{ fontSize: 30, textAlign: "center", color: 'red' }}>{route.params.death}</Text>
            </View>

            <View style={styles.card}>
                <Text style={{ padding: 16, fontSize: 38, textAlign: "center", color: "green" }}>Total recovered</Text>
                <Text style={{ fontSize: 30, textAlign: "center", color: 'green' }}>{route.params.recovered}</Text>
            </View>
